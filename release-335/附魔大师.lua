...
local T = {
    ...
    [2] = {
        -- 肩膀
        {"(铭文) +120 攻击强度，+15 爆击等级", 3835, false},
        {"(铭文) +70 法术强度，每5秒法力回复+8", 3836, false},
        {"(铭文) +60躲闪等级，+15 防御等级", 3837, false},
        {"(铭文) +70法术强度，+15 爆击等级", 3838, false},
    ...
    [6] = {
        ...
        {"+72 耐力，+35 敏捷", 3331, false},
        {"+100 攻击强度，+36 爆击等级", 3332, false},
    },
    [7] = {
        -- 鞋
        {"(工程) 硝化甘油推进器", 3606, false},
        {"+32 攻击强度", 1597, false},
    ...
    [14] = {
        -- 披风
        {"(裁缝) - 黑光刺绣(施法回蓝)", 3728, false},
        {"(裁缝) - 剑刃刺绣(攻强)", 3730, false},
        {"(裁缝) - 亮纹刺绣(法伤)", 3722, false},
        {"(工程) - +27 法术强度 弹力蛛丝", 3859, false},
        {"(工程) - +23 敏捷 高弹力衬肩", 3605, false},
        {"+35 法术穿透", 3243, false},
